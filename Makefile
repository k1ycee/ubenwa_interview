...
run-internal-test:
	flutter run --flavor internal --target lib/main_production.dart -v
...
run-stg:
	flutter run --flavor staging --target lib/main_staging.dart -v

run-prod:
	flutter run --flavor production --target lib/main_production.dart -v
